...
const images = [
  { src: AIDev, alt: 'AIDev Attendee', tag: "AI Dev x SF by Deeplearning.ai 2026", desc: "Keepin' up with Community" },
  ...
  { src: RA, alt: 'Research Participation', tag: "UNC Charlotte", desc: "Research participant for Anxiety Reduction via VR environments" },

  { src: Rochelle, alt: 'Rochelle', tag: "Cat Mom", desc: "Adopt, don't shop!" },
  { src: Guitar, alt: 'Guitar', tag: "Passtime Guitar Player", desc: "" },
